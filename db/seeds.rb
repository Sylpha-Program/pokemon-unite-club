...
Tool.create(name: 'じゃくてんほけん', image: 'tool_17.png')
Tool.create(name: 'こだわりメガネ', image: 'tool_18.png')
Tool.create(name: 'するどいツメ', image: 'tool_19.png')
...
Skill.create(pokemon_id: 14, button: 1, name: 'ふいうち', image: 'absol_skill_4.png', attack_category: 0, level: 7, cool_time: 6, attack_type: '妨害')
...
Skill.create(pokemon_id: 24, button: 0, name: 'つららおとし', image: 'mamoswine_skill_1.png', attack_category: 0, level: 6, cool_time: 8, attack_type: '妨害')
...
Skill.create(pokemon_id: 24, button: 1, name: 'つららおとし', image: 'mamoswine_skill_3.png', attack_category: 0, level: 8, cool_time: 8, attack_type: 'ムーブ')
Skill.create(pokemon_id: 24, button: 1, name: 'つららおとし', image: 'mamoswine_skill_4.png', attack_category: 0, level: 8, cool_time: 7.5, attack_type: 'ムーブ')
...
MySet.create(user_id: 1, pokemon_id: 6, r_skill_id: 22, zr_skill_id: 24, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 7, r_skill_id: 26, zr_skill_id: 28, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 8, r_skill_id: 29, zr_skill_id: 31, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 9, r_skill_id: 33, zr_skill_id: 35, battle_item_id: 5, tool_1_id: 4, tool_2_id: 5, tool_3_id: 18)
MySet.create(user_id: 1, pokemon_id: 10, r_skill_id: 37, zr_skill_id: 40, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 11, r_skill_id: 42, zr_skill_id: 44, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 12, r_skill_id: 45, zr_skill_id: 47, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 13, r_skill_id: 50, zr_skill_id: 52, battle_item_id: 5, tool_1_id: 4, tool_2_id: 5, tool_3_id: 18)
MySet.create(user_id: 1, pokemon_id: 14, r_skill_id: 54, zr_skill_id: 55, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 15, r_skill_id: 57, zr_skill_id: 59, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 16, r_skill_id: 62, zr_skill_id: 64, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 17, r_skill_id: 66, zr_skill_id: 67, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 18, r_skill_id: 69, zr_skill_id: 71, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 19, r_skill_id: 73, zr_skill_id: 75, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 20, r_skill_id: 77, zr_skill_id: 79, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 21, r_skill_id: 81, zr_skill_id: 84, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 2)
MySet.create(user_id: 1, pokemon_id: 22, r_skill_id: 86, zr_skill_id: 87, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
MySet.create(user_id: 1, pokemon_id: 23, r_skill_id: 89, zr_skill_id: 91, battle_item_id: 5, tool_1_id: 4, tool_2_id: 5, tool_3_id: 18)
MySet.create(user_id: 1, pokemon_id: 24, r_skill_id: 94, zr_skill_id: 96, battle_item_id: 5, tool_1_id: 6, tool_2_id: 7, tool_3_id: 12)
