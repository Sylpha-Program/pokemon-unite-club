...
Tool.create(name: 'ちからのハチマキ', image: 'tool_1.png')
Tool.create(name: 'かいがらのすず', image: 'tool_2.png')
Tool.create(name: 'エナジーアンプ', image: 'tool_3.png')
Tool.create(name: 'かるいし', image: 'tool_04.png')
Tool.create(name: 'おたすけバリア', image: 'tool_05.png')
Tool.create(name: 'ゴールサポーター', image: 'tool_6.png')
Tool.create(name: 'がくしゅうそうち', image: 'tool_07.png')
Tool.create(name: 'とつげきチョッキ', image: 'tool_8.png')
Tool.create(name: 'ピントレンズ', image: 'tool_9.png')
